...
public class UserController {
	...
	public String saveOrder(@ModelAttribute OrderDetails request, Principal p) throws Exception {
	...
	public String myOrder(Model m, Principal p) {
		...
		List<Product> orders = orderService.getOrdersByUser(loginUser.getId());
